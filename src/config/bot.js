...
export const botConfig = {
  ...
  applications: {
    ...
    defaultQuestions: [
      { question: "ชื่ออะไร (ชื่อเล่น)", required: true },
      { question: "ใครเป็นคนเชิญเข้ามา (ความจริง)", required: true },
      { question: "เพราะอะไรถึงอยากเข้า", required: true },
    ],
